...
export function SearchBox({ query, onQueryChange }: SearchBoxProps) {
  return (
    <div className="rounded-[24px] border border-[var(--border)] bg-[var(--surface-strong)] p-4 shadow-[var(--shadow-soft)]">
      ...
      <div className="mt-3 flex items-center gap-3 rounded-2xl border border-stone-200/80 bg-white/70 px-4 py-3">
